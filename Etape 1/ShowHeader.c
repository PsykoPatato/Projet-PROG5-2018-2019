...
int big = 0; //vaut 1 si fichier en big endian
...
void readHeader(FILE *f, Elf32_Ehdr *ehdr){
   ...
   readOctet(f, &ehdr->e_type, sizeof(ehdr->e_type));
   readOctet(f, &ehdr->e_machine, sizeof(ehdr->e_machine));
   readOctet(f, &ehdr->e_version, sizeof(ehdr->e_version));
   readOctet(f, &ehdr->e_entry, sizeof(ehdr->e_entry));
   readOctet(f, &ehdr->e_phoff, sizeof(ehdr->e_phoff));
   readOctet(f, &ehdr->e_shoff, sizeof(ehdr->e_shoff));
   readOctet(f, &ehdr->e_flags, sizeof(ehdr->e_flags));
   readOctet(f, &ehdr->e_ehsize, sizeof(ehdr->e_ehsize));
   readOctet(f, &ehdr->e_phentsize, sizeof(ehdr->e_phentsize));
   readOctet(f, &ehdr->e_phnum, sizeof(ehdr->e_phnum));
   readOctet(f, &ehdr->e_shentsize, sizeof(ehdr->e_shentsize));
   readOctet(f, &ehdr->e_shnum, sizeof(ehdr->e_shnum));
   readOctet(f, &ehdr->e_shstrndx, sizeof(ehdr->e_shstrndx));
